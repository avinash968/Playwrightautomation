...
$reportLink = "https://github.com/avinash968/Playwrightautomation/blob/$CommitSHA/test-results/$ReportFile"

$message = "*SCRUM-101 QA Report - $status*
*App:* dev.quote2cash.app

*Passed:* $Passed | *Failed:* $Failed | *Healed:* $Healed
*Pass Rate:* $PassRate% | *Duration:* $Duration | *Bugs:* $BugCount
